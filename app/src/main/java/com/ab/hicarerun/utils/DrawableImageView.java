...
//            if(mHostActivity instanceof Camera2Activity){
//                ((Camera2Activity)mHostActivity).dragStickerStarted();
//            }
//        }
//    }
//
...
//        if(mHostActivity != null){
//            if(mHostActivity instanceof Camera2Activity){
//                ((Camera2Activity)mHostActivity).dragStickerStopped();
//            }
//        }
//        removeCircle();
//    }
...
//        if(mHostActivity instanceof Camera2Activity){
//            ((Camera2Activity)mHostActivity).setTrashIconSize(TRASH_ICON_ENLARGED_SIZE, TRASH_ICON_ENLARGED_SIZE);
//        }
//    }
//
//    public void shrinkTrashIcon(){
//        if(mHostActivity instanceof Camera2Activity){
//            ((Camera2Activity)mHostActivity).setTrashIconSize(TRASH_ICON_NORMAL_SIZE, TRASH_ICON_NORMAL_SIZE);
//        }
//    }
//
...
//        if(mHostActivity != null){
//            if(mHostActivity instanceof Camera2Activity){
//                ((Camera2Activity)mHostActivity).hideStillshotWidgets();
//            }
//        }
//    }
//
...
//        if(mHostActivity != null){
//            if(mHostActivity instanceof Camera2Activity){
//                ((Camera2Activity)mHostActivity).showStillshotWidgets();
//            }
//        }
//        removeCircle();
//    }
