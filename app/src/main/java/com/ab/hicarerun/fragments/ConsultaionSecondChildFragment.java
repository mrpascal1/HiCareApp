 ...
 */
public class ConsultaionSecondChildFragment extends Fragment implements UserSecondConsultationHandler, OnConsultationClickHandler {
    FragmentConsultaionSecondChildBinding mFragmentConsultaionSecondChildBinding;
    ...
    public ConsultaionSecondChildFragment() {
        // Required empty public constructor
    }

    public static ConsultaionSecondChildFragment newInstance() {
        Bundle args = new Bundle();
        ConsultaionSecondChildFragment fragment = new ConsultaionSecondChildFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFragmentConsultaionSecondChildBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_consultaion_second_child, container, false);
        mFragmentConsultaionSecondChildBinding.setHandler(this);
        return mFragmentConsultaionSecondChildBinding.getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mFragmentConsultaionSecondChildBinding.txtPart.setTypeface(mFragmentConsultaionSecondChildBinding.txtPart.getTypeface(), Typeface.BOLD);
            ...
            if (inspectionList.size() == mAdapter.getItemCount()) {
                if (isListChecked(inspectionList)) {
                    if (isImgChecked(inspectionList)) {
                        mFragmentConsultaionSecondChildBinding.btnSave.setEnabled(true);
                        mFragmentConsultaionSecondChildBinding.btnSave.setAlpha(1.0f);
                    } else {
                        mFragmentConsultaionSecondChildBinding.btnSave.setEnabled(false);
                        mFragmentConsultaionSecondChildBinding.btnSave.setAlpha(0.6f);
                    }
        ...
        mFragmentConsultaionSecondChildBinding.recycleView.setLayoutManager(new LinearLayoutManager(getActivity()));
        mFragmentConsultaionSecondChildBinding.recycleView.setHasFixedSize(true);
        mFragmentConsultaionSecondChildBinding.recycleView.setClipToPadding(false);
        mFragmentConsultaionSecondChildBinding.recycleView.setAdapter(mAdapter);
        mFragmentConsultaionSecondChildBinding.txtTitle.setTypeface(mFragmentConsultaionSecondChildBinding.txtTitle.getTypeface(), Typeface.BOLD);
        getConsulations();
    }
    ...
    private void getConsulations() {
        try {
            ...
            if (AppUtils.inspectionList != null && AppUtils.inspectionList.size() > 0) {
                inspectionList = AppUtils.inspectionList;
...
//        transaction.commit();
    ...
    interface ChildFragment2Listener {
        void onBackClicked();
